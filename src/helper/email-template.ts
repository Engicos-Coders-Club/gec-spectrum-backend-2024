...
<strong>${otp}</strong> is the OTP to verify your account on our <a href="https://www.gecspectrum.com/" target="_blank" title="GEC Spectrum 2024 wesbite" style="text-decoration: underline; color: #5c17cb;" rel="noopener">website</a>. This OTP is usable only once. Please do not share with anyone.</p></div></td></tr></table></td></tr></tbody></table></td></tr></tbody></table><table class="row row-3" align="center" width="100%" border="0" cellpadding="0" cellspacing="0" 
